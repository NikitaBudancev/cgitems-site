<template>
  <div class="images-block">
    ...
    >
      <input :id="`project_images_${index}`" accept="image/jpeg,image/x-png" />
      <label
      ...
      <div class="removeImage" data-num="0" data-id="0" data-stage="">
        <svg
          width="18"
          height="20"
          viewBox="0 0 18 20"
    ...
    <div v-for="n in 3" :key="n" class="project_images">
      <CropperMain
