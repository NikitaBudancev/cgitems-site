        ...
        <div class="footer__menu-wrap">
          <div class="footer__menu">
            <div class="footer__menu-item">
              ...
              <nav
                class="header__item menu"
                data-sidebar="menu"
                style="left: -100%"
              >
                <ul class="menu__list list">
                  <li class="menu__item mobile-search-item">
                    <a class="link menu__link search_link" href="/search/"
                      >Поиск</a
                    >
                  </li>

                  <li class="menu__item parent">
                    <a class="link menu__link course-link" href="/">Курсы</a>
                    <div class="menu__list-wrapper">
                      <ul class="menu__list list">
                        ...
                        <li class="menu__item">
                          <a
                            class="link menu__link active vehicles-and-props_link"
                  ...
                  <li class="menu__item">
                    <a class="link menu__link projects_link" href="/projects/"
                      >Работы студентов</a
                    >
                  </li>

                  <li class="menu__item parent">
                    <a class="link menu__link articles_link" href="/articles/"
                      >Статьи о 3D</a
                    >
                    <div class="menu__list-wrapper">
                      <ul class="menu__list list">
                  ...
                  <li class="menu__item">
                    <a class="link menu__link reviews_link" href="/reviews/"
                      >Отзывы</a
                    >
                  </li>
            ...
            <div class="footer__menu-item">
              <ul class="list footer__menu-list">
                <li class="footer__menu-list-item">
                  <a class="link footer__menu-list-link" href="/privacy-policy/"
            ...
            <div class="footer__menu-item">
              <ul class="list footer__menu-list">
                ...
                <li class="footer__menu-list-item">
                  <a class="link" href="mailto:info@cgitems.ru"
                    >info@cgitems.ru</a
                  >
                </li>
                <li class="footer__menu-list-item">
                  <a class="link" href="tel:+79015938910">+7 (901) 593-89-10</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="footer__menu-text text-end">
            Все права защищены. Ⓒ Николай Викторович Андрианов, 2023
          </div>
        </div>
      </div>
    </div>
